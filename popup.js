...
window.popup = function(title, context, callbacks){
  var bool = true;
  ...
  contextBox.style.border = "solid 1px #AAA";
  ...
  popup.style.boxShadow = "1px 1px 2px #333";
  popup.style.color = "#000";
  popup.style.backgroundColor = "#FFFFFF";
  popup.style.border = "solid 2px var(--main-color)";
